            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group" style="display: flex;justify-content:center">
                            <div class="col-md-3">
                                <input name="submit" type="submit" class="btn btn-primary form-control" value="Update Product">
                            </div>
                        </div>
...
if (isset($_POST['submit'])) {
    ...
    $update_product = "Update set products(p_cat_id,cat_id,date,product_title,product_img1,product_img2,product_price,product_keywords,product_desc)
    values ('$p_cat_id','$cat_id',NOW(),'$product_title','$product_img1','$product_img2','$product_price','$product_keywords','$product_desc')";
    ...
    if ($run_update_product) {
        ...
        echo "<script>window.open('update-product.php','_self')</script>";
    }
}
