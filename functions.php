...
function getWProduct()
{
    ...
    while ($row_products = mysqli_fetch_array($run_products)) {
        ...
        <div class='pi-pic' style='max-height:300px'>
            ...
            <ul>
                <li class='quick-view'><a href='product.php?products_id=$products_id' style='background:#fe4231;color:white'>View Details</a></li>
            </ul>
        </div>
        <div class='pi-text'>
    ...
    <div class='card col-md-3 col-10' style='margin:0 auto; border-radius:25px 5px;box-shadow: inset -12px -8px 40px #e5e5e5;'>
        ...
        <tr style='border-bottom: 0.5px solid #ebebeb'>
           ...
           <td class='cart-title first-row'>
               <h5><a href='product.php?products_id=$pro_id' style='color:black;font-weight:bold'>$pro_name</h5>
           </td>
