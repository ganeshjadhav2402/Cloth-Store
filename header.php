...
<meta charset="UTF-8">
<meta name="description" content="Param Sales">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Param Sales</title>
...
<body>
            ...
            <div class="container">
                ...
                <nav class="nav-menu mobile-menu">
                    <ul>
                        ...
                        <li class="<?php if ($active == 'Admin') echo "active" ?>"><a href="adminlogin.php">Admin</a></li>
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($count > 0) {
            ...
            echo "<script>window.open('product.php?products_id=$products_id','_self')</script>";
        } else {
